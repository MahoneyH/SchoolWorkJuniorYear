...
public class ShortestJob {
    ...
    public void SJF (ArrayList<PCB>jobList, ArrayList<PCB> ready ,ArrayList<PCB> io,ArrayList<PCB> disk,PCB[] cpu, SystemTimer timer){
    ...
    public void printJobQ(ArrayList<PCB>jobList){
        
        String list ="";
        
        for(int i =0; i<jobList.size(); i++ ){
            list = list + " " + jobList.get(i).getPcbNum() + " ";
